  ...
  return (
    <main className="min-h-[70vh] py-20 sm:py-24">
      <div className="mx-auto max-w-3xl px-6 lg:px-8">
        ...
        <h1 className="mt-3 flex items-center gap-3 text-4xl font-semibold tracking-tight text-white sm:text-5xl"><GraduationCap className="size-9 text-[#f8c268]" strokeWidth={1.7} aria-hidden="true" />Year {yearIndex + 1}</h1>
