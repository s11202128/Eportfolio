...
import { CircleUserRound, Sparkles } from "@/components/icons";
...
export default function AboutPage() {
  return (
    <main>
      <Section icon={CircleUserRound} eyebrow="Introduction" title="About Me" description="A concise introduction to the person and purpose behind this portfolio.">
      ...
      <Section icon={Sparkles} eyebrow="Purpose" title="A portfolio built around evidence" className="bg-[#0b2b2f]">
