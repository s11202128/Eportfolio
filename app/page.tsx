        ...
        <div className="mx-auto grid min-h-[43rem] max-w-6xl items-center gap-14 px-6 py-20 lg:grid-cols-[1.25fr_0.75fr] lg:px-8">
          <div>
            ...
            <div className="mt-10 flex flex-wrap gap-x-6 gap-y-3 border-t border-[#78bac7]/25 pt-6 text-sm">
              ...
              <Link className="inline-flex items-center gap-2 font-semibold text-[#f8c268] underline-offset-4 hover:underline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-[#f8c268]" href="/contact"><Mail size={15} aria-hidden="true" />Email</Link>
            </div>
          </div>
