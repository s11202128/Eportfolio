    ...
    <main className="min-h-[70vh] py-20 sm:py-24">
      <div className="mx-auto max-w-3xl px-6 lg:px-8">
        ...
        <div className="mt-10 flex flex-wrap gap-3">
          ...
          <a className="inline-flex min-h-11 items-center justify-center gap-2 rounded-md border border-[#78bac7]/60 px-5 py-2.5 text-sm font-semibold text-white transition-colors hover:border-[#f8c268] hover:bg-white/5 focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-[#f8c268]" href={profile.socialLinks.gmail} target="_blank" rel="noreferrer"><Mail size={16} aria-hidden="true" />Open Gmail</a>
